...
(function($) {
    ...
    versionSelect.on('change', function() {
        ...
        if (this.value === 'light') {
            jQuery(".nav-header .logo-abbr").attr("src", "./backend/assets/images/logo.png");
            jQuery(".nav-header .logo-compact").attr("src", "/backend/assets/images/logo-text.png");
            jQuery(".nav-header .brand-title").attr("src", "/backend/assets/images/logo-text.png");

            setCookie('logo_src', './backend/assets/images/logo.png');
            setCookie('logo_src2', '/backend/assets/images/logo-text.png');
        } else {
            jQuery(".nav-header .logo-abbr").attr("src", "./backend/assets/images/logo-white.png");
            jQuery(".nav-header .logo-compact").attr("src", "/backend/assets/images/logo-text-white.png");
            jQuery(".nav-header .brand-title").attr("src", "/backend/assets/images/logo-text-white.png");

            setCookie('logo_src', './backend/assets/images/logo-white.png');
            setCookie('logo_src2', '/backend/assets/images/logo-text-white.png');
        }

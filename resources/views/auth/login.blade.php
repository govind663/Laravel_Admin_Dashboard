                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" role="form" enctype="multipart/form">
                                        @csrf

                                        <div class="form-group">
                                            <label class="mb-1"><strong>{{ __('Email Address') }} : <span class="text-danger">*</span></strong></label>
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus placeholder="Enter your email address.">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="current-password" autofocus placeholder="Enter your password.">

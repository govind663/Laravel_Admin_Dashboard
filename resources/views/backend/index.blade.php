...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/backend/assets/vendor/chartist/css/chartist.min.css">
    <link href="{{ url('/') }}/backend/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="{{ url('/') }}/backend/assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        @include('common.Nav_Header.nav_header')
        <!--**********************************
            Nav header end
        ***********************************-->
        ...
        <!--**********************************
            Chat box start
        ***********************************-->
        @include('common.Chat_Box.chatbox')
        <!--**********************************
            Chat box End
        ***********************************-->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-bx stacked card">
                                    <img src="{{ url('/') }}/backend/assets/images/card/card1.jpg" alt="">
                                    <div class="card-info">
                            ...
                            <div class="col-sm-6">
                                <div class="card-bx stacked card">
                                    <img src="{{ url('/') }}/backend/assets/images/card/card2.jpg" alt="">
                                    <div class="card-info">
                            ...
                            <div class="col-sm-6">
                                <div class="card-bx stacked card">
                                    <img src="{{ url('/') }}/backend/assets/images/card/card3.jpg" alt="">
                                    <div class="card-info">
                                        <p class="mb-1 text-white fs-14">Main Balance</p>
                                        <div class="d-flex justify-content-between">
                                            <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                            ...
                            <div class="col-sm-6">
                                <div class="card-bx stacked card">
                                    <img src="{{ url('/') }}/backend/assets/images/card/card4.jpg" alt="">
                                    <div class="card-info">
                                        <p class="mb-1 text-white fs-14">Main Balance</p>
                                        <div class="d-flex justify-content-between">
                                            <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                                        ...
                                        <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                            <div class="items">
                                                <div class="text-center">
                                                    <img class="mb-3 rounded" src="{{ url('/') }}/backend/assets/images/contacts/Untitled-1.jpg" alt="">
                                            ...
                                            <div class="items">
                                                <div class="text-center">
                                                    <img class="mb-3 rounded" src="{{ url('/') }}/backend/assets/images/contacts/Untitled-2.jpg" alt="">
                                            ...
                                            <div class="items">
                                                <div class="text-center">
                                                    <img class="mb-3 rounded" src="{{ url('/') }}/backend/assets/images/contacts/Untitled-3.jpg" alt="">
                                            ...
                                            <div class="items">
                                                <div class="text-center">
                                                    <img class="mb-3 rounded" src="{{ url('/') }}/backend/assets/images/contacts/Untitled-4.jpg" alt="">
                                            ...
                                            <div class="items">
                                                <div class="text-center">
                                                    <img class="mb-3 rounded" src="{{ url('/') }}/backend/assets/images/contacts/Untitled-5.jpg" alt="">
    ...
    ***********************************-->
    ...
    <script src="{{ url('/') }}/backend/assets/vendor/chart.js/Chart.bundle.min.js"></script>

    <!-- Chart piety plugin files -->
    <script src="{{ url('/') }}/backend/assets/vendor/peity/jquery.peity.min.js"></script>

    <!-- Apex Chart -->
    <script src="{{ url('/') }}/backend/assets/vendor/apexchart/apexchart.js"></script>

    <!-- Dashboard 1 -->
    <script src="{{ url('/') }}/backend/assets/js/dashboard/dashboard-1.js"></script>

    <script src="{{ url('/') }}/backend/assets/vendor/owl-carousel/owl.carousel.js"></script>
